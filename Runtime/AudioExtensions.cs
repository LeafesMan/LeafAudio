...
namespace LeafAudio
{
    ...
    public static class AudioExtensions
    {
        ...
        /// </summary>
        public static PlaybackHandle Play(this Sound sound, Vector3? position = null, Transform origin = null, float loops = 1) => Audio.GlobalManager.Play(sound, position, origin, loops);
        /// <summary>
